...
function logTag() {
  {
    console.log('%c❤️ Welcome to klinecharts. Version is 8.0.0', 'border-radius:2px;border:dashed 1px #2196F3;padding:26px 20px;font-size:14px;color:#2196F3');
  }
}
...
var TimeScaleStore = /*#__PURE__*/function () {
  function TimeScaleStore(chartData) {
  ...
  _createClass(TimeScaleStore, [{
    ...
    value: function adjustFromTo() {
      var dataSize = this._chartData.dataList().length;
      ...
      this._chartData.adjustVisibleDataList(); // 处理加载更多，有更多并且没有在加载则去加载更多
    ...
    value: function scroll(distance, crosshair) {
      ...
      this._chartData.actionStore().execute(ActionType.SCROLL, {
      ...
      var cross = crosshair || this._chartData.crosshairStore().get();
    ...
    value: function zoom(scale, coordinate) {
      ...
      if (!coordinate || !isValid(coordinate.x)) {
        var crosshair = this._chartData.crosshairStore().get();
      ...
      this._chartData.actionStore().execute(ActionType.ZOOM, {
...
var TechnicalIndicatorStore = /*#__PURE__*/function () {
  function TechnicalIndicatorStore(chartData) {
    _classCallCheck(this, TechnicalIndicatorStore);

    this._chartData = chartData; // 指标模板
  ...
  _createClass(TechnicalIndicatorStore, [{
      ...
      if (isValid(name)) {
        if (isValid(paneId)) {
          ...
          this._instances.forEach(function (paneInstances) {
            if (paneInstances.has(name)) {
              paneInstances.get(name).calc(_this2._chartData.dataList());
              calcSuccess = true;
            }
          });
        }
        ...
        this._instances.forEach(function (paneInstances) {
          paneInstances.forEach(function (instance) {
            instance.calc(_this2._chartData.dataList());
            calcSuccess = true;
          });
        });
      }
    ...
    value: function override(techOverride, paneId) {
      ...
      var defaultTechStyleOptions = this._chartData.styleOptions().technicalIndicator;
      ...
      instances.forEach(function (paneInstances) {
        if (paneInstances.has(name)) {
          ...
          if (calcParamsSuccess) {
            tasks.push(Promise.resolve(tech.calc(_this4._chartData.dataList())));
          }
        }
      });
...
var Shape = /*#__PURE__*/function (_Overlay) {
  ...
  function Shape(_ref) {
    ...
    _this.setStyles(styles, chartData.styleOptions().shape);
  ...
  _createClass(Shape, [{
    ...
    value: function draw(ctx) {
      ...
      var shapeOptions = this._styles || this._chartData.styleOptions().shape;
      ...
      var shapeMouseOperate = this._chartData.shapeStore().mouseOperate();
    ...
    value: function checkEventCoordinateOn(eventCoordinate) {
      var shapeOptions = this._styles || this._chartData.styleOptions().shape; // 检查鼠标点是否在图形的点上
    ...
    value: function _performValue(y, dataIndex, paneId) {
      ...
      var kLineData = this._chartData.timeScaleStore().getDataByDataIndex(dataIndex);
    ...
    value: function mouseMoveForDrawing(coordinate, event) {
      ...
      var timestamp = this._chartData.timeScaleStore().dataIndexToTimestamp(dataIndex);
    ...
    value: function mousePressedOtherMove(coordinate) {
      var _this3 = this;
      ...
      if (this._prevPressPoint) {
        ...
        this._points = this._prevPoints.map(function (point) {
          ...
          if (!isValid(point.dataIndex)) {
            point.dataIndex = _this3._chartData.timeScaleStore().timestampToDataIndex(point.timestamp);
          }
          ...
          return {
            dataIndex: dataIndex,
            value: value,
            timestamp: _this3._chartData.timeScaleStore().dataIndexToTimestamp(dataIndex)
          };
        });
      }
    } // -------------------- 事件开始 -------------------
...
var ShapeStore = /*#__PURE__*/function () {
  function ShapeStore(chartData) {
    _classCallCheck(this, ShapeStore);

    this._chartData = chartData; // 图形标记映射
  ...
  _createClass(ShapeStore, [{
    ...
    value: function setInstanceOptions() {
      ...
      var defaultStyles = this._chartData.styleOptions().shape;
...
var AnnotationStore = /*#__PURE__*/function () {
  function AnnotationStore(chartData) {
    _classCallCheck(this, AnnotationStore);

    this._chartData = chartData; // 注解标记
  ...
  _createClass(AnnotationStore, [{
    ...
    value: function createVisibleAnnotations() {
      ...
      if (this._annotations.size > 0) {
        this._chartData.visibleDataList().forEach(function (_ref) {
          var data = _ref.data,
              x = _ref.x;
...
var TagStore = /*#__PURE__*/function () {
  function TagStore(chartData) {
    _classCallCheck(this, TagStore);

    // 刷新回调
    this._chartData = chartData; // 标签
...
var CrosshairStore = /*#__PURE__*/function () {
  function CrosshairStore(chartData) {
    _classCallCheck(this, CrosshairStore);

    this._chartData = chartData; // 十字光标信息
  ...
  _createClass(CrosshairStore, [{
    ...
    value: function set(crosshair, notInvalidate) {
      ...
      var realX = this._chartData.timeScaleStore().dataIndexToCoordinate(realDataIndex);
...
var TechnicalIndicatorView = /*#__PURE__*/function (_View) {
  ...
  function TechnicalIndicatorView(container, chartData, xAxis, yAxis, paneId) {
    var _this;
  ...
  _createClass(TechnicalIndicatorView, [{
    ...
    value: function _drawTechs() {
      ...
      var techOptions = this._chartData.styleOptions().technicalIndicator;

      var techs = this._chartData.technicalIndicatorStore().instances(this._paneId);
      ...
      techs.forEach(function (tech) {
        ...
        if (tech.render) {
          ...
          tech.render({
            ctx: _this3._ctx,
            dataSource: {
              from: _this3._chartData.timeScaleStore().from(),
              to: _this3._chartData.timeScaleStore().to(),
            ...
            viewport: {
              ...
              dataSpace: _this3._chartData.timeScaleStore().dataSpace(),
              barSpace: _this3._chartData.timeScaleStore().barSpace()
            },
            styles: styles,
            xAxis: _this3._xAxis,
            yAxis: _this3._yAxis
                  ...
                  if (isValid(value)) {
                    var cbData = {
                      prev: {
                        ...
                        technicalIndicatorData: techResult[i - 1]
                      },
                      current: {
                        kLineData: kLineData,
    ...
    value: function _drawGraphics(onDrawing, onDrawEnd) {
      ...
      var barSpace = this._chartData.timeScaleStore().barSpace();

      var halfBarSpace = this._chartData.timeScaleStore().halfBarSpace();
...
var TechnicalIndicatorOverlayView = /*#__PURE__*/function (_View) {
  ...
  function TechnicalIndicatorOverlayView(container, chartData, xAxis, yAxis, paneId) {
    var _this;
  ...
  _createClass(TechnicalIndicatorOverlayView, [{
    ...
    value: function _drawAnnotation() {
      ...
      var annotations = this._chartData.annotationStore().get(this._paneId);
    ...
    value: function _drawTag() {
      ...
      var tags = this._chartData.tagStore().get(this._paneId);
    ...
    value: function _drawShape() {
      ...
      this._chartData.shapeStore().instances(this._paneId).forEach(function (shape) {
        shape.draw(_this4._ctx);
      });

      var progressShape = this._chartData.shapeStore().progressInstance();
    ...
    value: function _drawTechTooltip(crosshair, tech, techOptions) {
      ...
      var techResult = tech.result;
      var techData = techResult[crosshair.dataIndex];
      var tooltipData = getTechnicalIndicatorTooltipData(techData, tech);
      ...
      var cbData = {
        prev: {
          ...
          technicalIndicatorData: techResult[crosshair.dataIndex - 1]
        },
        current: {
      ...
      plots.forEach(function (plot, i) {
        ...
        if (isValid(title)) {
          labelX += textMarginLeft;
          var text = "".concat(title).concat(values[i].value || techTooltipTextOptions.defaultValue);
          var textWidth = calcTextWidth(_this6._ctx, text);
          renderText(_this6._ctx, valueColor, labelX, labelY, text);
...
var YAxisView = /*#__PURE__*/function (_View) {
  ...
  function YAxisView(container, chartData, yAxis, paneId) {
    var _this;
  ...
  _createClass(YAxisView, [{
    ...
    value: function _drawLastPriceLabel() {
      ...
      this._drawMarkLabel(close, this._chartData.pricePrecision(), false, _objectSpread2(_objectSpread2({}, lastPriceMarkOptions.text), {}, {
        backgroundColor: backgroundColor
      }));
    }
    /**
...
var YAxisOverlayView = /*#__PURE__*/function (_View) {
  ...
  function YAxisOverlayView(container, chartData, yAxis, paneId) {
    var _this;
...
var YAxis = /*#__PURE__*/function (_Axis) {
  ...
  function YAxis(chartData, isCandleYAxis, paneId) {
    var _this;
...
var TechnicalIndicatorPane = /*#__PURE__*/function (_Pane) {
  ...
  _createClass(TechnicalIndicatorPane, [{
    ...
    value: function _createYAxis(props) {
      return new YAxis(props.chartData, false, props.id);
    }
  }, {
    key: "_createMainWidget",
    value: function _createMainWidget(container, props) {
    ...
    value: function _drawArea(candleOptions) {
      ...
      var onDrawEnd = function onDrawEnd() {
        ...
        if (areaCoordinateLength > 0) {
          ...
          var halfBarSpace = _this._chartData.timeScaleStore().halfBarSpace();
  ...
  _createClass(CandleOverlayView, [{
    ...
    value: function _drawCandleTooltipWithRect(crosshair, techs, candleOptions, isDrawCandleTooltip, techOptions, isDrawTechTooltip) {
      ...
      if (isDrawTechTooltip) {
        ...
        techTooltipDataList.forEach(function (_ref) {
          ...
          tooltipData.values.forEach(function (_ref2) {
            ...
            if (isValid(title)) {
              var v = value || techTooltipOptions.defaultValue;
      ...
      if (isDrawTechTooltip) {
        // 开始渲染指标数据文字
        var _techOptions = this._chartData.styleOptions().technicalIndicator;

        var indicatorLabelX = rectX + rectBorderSize + rectPaddingLeft + techTooltipTextMarginLeft;
        this._ctx.font = createFont(techTooltipTextSize, techTooltipOptions.text.weight, techTooltipOptions.text.family);
        techTooltipDataList.forEach(function (_ref3) {
          var name = _ref3.name,
              tooltipData = _ref3.tooltipData,
              cbData = _ref3.cbData;
          var tech = techs.get(name);
          var styles = tech.styles || _techOptions;
          var colors = styles.line.colors;
          var colorSize = colors.length;
          var plots = tech.plots;
          var lineCount = 0;
          ...
          plots.forEach(function (plot, i) {
            ...
            if (isValid(value.title)) {
              ...
              _this2._ctx.fillText(value.value || techTooltipOptions.defaultValue, rectX + rectWidth - rectBorderSize - techTooltipTextMarginRight - rectPaddingRight, labelY);
      ...
      if (baseValues) {
        ...
        values.forEach(function (value, index) {
          switch (index) {
            case 0:
              {
                values[index] = formatDate(_this3._chartData.timeScaleStore().dateTimeFormat(), value, 'YYYY-MM-DD hh:mm');
                break;
              }
...
var XAxisOverlayView = /*#__PURE__*/function (_View) {
  ...
  _createClass(XAxisOverlayView, [{
    ...
    value: function _drawCrosshairLabel() {
      ...
      var text = formatDate(this._chartData.timeScaleStore().dateTimeFormat(), timestamp, 'YYYY-MM-DD hh:mm');
...
var XAxis = /*#__PURE__*/function (_Axis) {
  ...
  _createClass(XAxis, [{
    ...
    value: function _computeMinMax() {
      return {
        min: this._chartData.timeScaleStore().from(),
        max: this._chartData.timeScaleStore().to() - 1
      };
    }
  }, {
    key: "_optimalMinMax",
    ...
    value: function _optimalTicks(ticks) {
      ...
      if (tickLength > 0) {
        var dateTimeFormat = this._chartData.timeScaleStore().dateTimeFormat();
...
var EventHandler = function EventHandler(chartData) {
...
var ZoomScrollEventHandler = /*#__PURE__*/function (_EventHandler) {
  ...
  function ZoomScrollEventHandler(chartData) {
    ...
    _this._startScrollCoordinate = {}; // 开始触摸时坐标
    ...
    value: function mouseWheelEvent(event) {
      if (Math.abs(event.deltaX) > Math.abs(event.deltaY)) {
        ...
        if (deltaY !== 0) {
          ...
          this._chartData.timeScaleStore().zoom(scale, {
            x: event.localX,
            y: event.localY
          });
        }
...
var OverlayEventHandler = /*#__PURE__*/function (_EventHandler) {
  ...
  function OverlayEventHandler(chartData, yAxis) {
    var _this;
  ...
  _createClass(OverlayEventHandler, [{
    ...
    value: function mouseMoveEvent(event) {
      ...
      var _this$_chartData$shap = this._chartData.shapeStore().progressInstance(),
          paneId = _this$_chartData$shap.paneId,
          instance = _this$_chartData$shap.instance;
      ...
      if (instance && instance.isDrawing()) {
        ...
        var annotations = this._chartData.annotationStore().get(event.paneId);

        var shapes = this._chartData.shapeStore().instances(event.paneId);

        var prevShapeHoverOperate = this._chartData.shapeStore().mouseOperate().hover;

        var prevAnnotationHoverOperate = this._chartData.annotationStore().mouseOperate();
      ...
      this._chartData.annotationStore().setMouseOperate(annotationHoverOperate || {
        id: ''
      });
    ...
    value: function mouseDownEvent(event) {
      ...
      var _this$_chartData$shap2 = this._chartData.shapeStore().progressInstance(),
          instance = _this$_chartData$shap2.instance,
          paneId = _this$_chartData$shap2.paneId;
      ...
      if (instance && instance.isDrawing() && paneId === event.paneId) {
        ...
        var visibleAnnotations = this._chartData.annotationStore().get(event.paneId);
      ...
      var shapeOperateValid = this._chartData.shapeStore().setMouseOperate({
        hover: shapeHoverOperate,
        click: shapeClickOperate || {
          id: '',
          element: ShapeMouseOperateElement.NONE,
    ...
    value: function mouseRightDownEvent(event) {
      var _this$_chartData$shap3 = this._chartData.shapeStore().progressInstance(),
          instance = _this$_chartData$shap3.instance;
    ...
    key: "pressedMouseMoveEvent",
    value: function pressedMouseMoveEvent(event) {
      var _this$_chartData$shap4 = this._chartData.shapeStore().pressedInstance(),
          instance = _this$_chartData$shap4.instance,
          paneId = _this$_chartData$shap4.paneId,
          element = _this$_chartData$shap4.element;
...
var ChartEvent = /*#__PURE__*/function () {
  function ChartEvent(target, chartData, yAxis) {
...
var Annotation = /*#__PURE__*/function (_Overlay) {
  ...
  _createClass(Annotation, [{
    ...
    value: function draw(ctx) {
      ...
      var isActive = this._id === this._chartData.annotationStore().mouseOperate().id;
...
var ChartPane = /*#__PURE__*/function () {
  function ChartPane(container, styleOptions) {
    ...
    this._chartWidth = {};
    this._chartHeight = {};
    this._chartEvent = new ChartEvent(this._chartContainer, this._chartData, function (paneId) {
  ...
  _createClass(ChartPane, [{
    ...
    value: function _crosshairObserver(_ref) {
      ...
      if (this.chartData().actionStore().has(ActionType.CROSSHAIR)) {
        ...
        this._panes.forEach(function (_, id) {
          ...
          var techs = _this2.chartData().technicalIndicatorStore().instances(id);
    ...
    value: function _separatorDrag(dragDistance, topPaneId, bottomPaneId) {
      ...
      this._chartData.actionStore().execute(ActionType.PANE_DRAG, {
        topPaneId: topPaneId,
    ...
    value: function removeTechnicalIndicator(paneId, name) {
      ...
      var removed = this._chartData.technicalIndicatorStore().removeInstance(paneId, name);
    ...
    value: function createTag(tags, paneId) {
      ...
      tags.forEach(function (_ref3) {
        ...
        if (isValid(id)) {
          if (_this7._chartData.tagStore().has(id, paneId)) {
            var updateSuccess = _this7._chartData.tagStore().update(id, paneId, {
              point: point,
              text: text,
              mark: mark,
              styles: styles
          ...
          if (pane.id() === paneId) {
            coordinates = points.map(function (_ref5) {
              ...
              if (isValid(timestamp)) {
                index = _this8._chartData.timeScaleStore().timestampToDataIndex(timestamp);
              }
          ...
          if (pane.id() === paneId) {
            points = coordinates.map(function (_ref7) {
              ...
              if (isValid(x)) {
                ...
                point.timestamp = _this9._chartData.timeScaleStore().dataIndexToTimestamp(point.dataIndex);
              }
...
var Chart = /*#__PURE__*/function () {
  ...
  _createClass(Chart, [{
    ...
    value: function applyNewData(dataList, more) {
      ...
      var chartData = this._chartPane.chartData();

      chartData.clearDataList();
      chartData.addData(dataList, 0, more);
      Promise.resolve(chartData.technicalIndicatorStore().calcInstance()).then(function (result) {
        if (result) {
    ...
    value: function overrideTechnicalIndicator(techOverride, paneId) {
      ...
      var promise = this._chartPane.chartData().technicalIndicatorStore().override(techOverride, paneId);
    ...
    value: function createShape(value, paneId) {
      ...
      var Shape = this._chartPane.chartData().shapeStore().getTemplate(shapeOptions.name);
    ...
    value: function scrollByDistance(distance, animationDuration) {
      ...
      if (isNumber(animationDuration) && animationDuration > 0) {
        ...
        var animation = function animation() {
          ...
          _this5._chartPane.chartData().timeScaleStore().scroll(dis);
    ...
    value: function scrollToRealTime(animationDuration) {
      var difBarCount = this._chartPane.chartData().timeScaleStore().offsetRightBarCount() - this._chartPane.chartData().timeScaleStore().offsetRightSpace() / this._chartPane.chartData().timeScaleStore().dataSpace();

      var distance = difBarCount * this._chartPane.chartData().timeScaleStore().dataSpace();
    ...
    value: function scrollToDataIndex(dataIndex, animationDuration) {
      ...
      var distance = (this._chartPane.chartData().dataList().length - 1 - dataIndex) * this._chartPane.chartData().timeScaleStore().dataSpace();
    ...
    value: function zoomAtCoordinate(scale, coordinate, animationDuration) {
      ...
      if (isNumber(animationDuration) && animationDuration > 0) {
        var dataSpace = this._chartPane.chartData().timeScaleStore().dataSpace();
        ...
        var animation = function animation() {
          ...
          _this6._chartPane.chartData().timeScaleStore().zoom(progressDataSpace / dataSpace, coordinate);
    ...
    value: function zoomAtDataIndex(scale, dataIndex, animationDuration) {
      ...
      var x = this._chartPane.chartData().timeScaleStore().dataIndexToCoordinate(dataIndex);
